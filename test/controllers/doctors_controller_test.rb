...
class DoctorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create doctor" do
    assert_difference('Doctor.count') do
      post doctors_url, params: { doctor: { age: @doctor.age, name: @doctor.name, nurse: @doctor.nurse } }
    end
  ...
  test "should update doctor" do
    patch doctor_url(@doctor), params: { doctor: { age: @doctor.age, name: @doctor.name, nurse: @doctor.nurse } }
